...
- **Principal-grade architectural leadership.** Underspecified problem domain → spec corpus → implementation → enforcement layer (tests, invariants, release gates). Eight months of compounding architectural decisions on a production platform is the proof.
